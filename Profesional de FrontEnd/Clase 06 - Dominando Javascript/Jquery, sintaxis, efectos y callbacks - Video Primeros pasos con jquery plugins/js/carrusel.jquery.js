	...
	$.fn.carrusel = function(prev, sig) {
		return this.each(function(){
			...
			if($container){
				...
				var enCarrusel = Math.floor($(this).width() / incremento);
				var primerElemento = 1;
				var estaMoviendo = false;
			}

			$container.css('width', (cantidad + enCarrusel) * incremento);
			for(var i = 0; i < enCarrusel; i++) {
